local enums = {
    ...
    helltide_tps = {
        {name = {"Frac_Tundra_S", "Frac_Kyovashad", "Frac_Tundra_N"}, id = 0xACE9B, file = "menestad"},
        {name = {"Scos_Coast"}, id = 0x27E01, file = "marowen"},
        {name = {"Kehj_Oasis", "Kehj_Caldeum", "Kehj_HighDesert","Kehj_LowDesert"}, id = 0xDEAFC, file = "ironwolfs"},
    ...
    maiden_positions = {
        ...
        marowen   = vec3:new(-1982.549438, -1143.823364, 12.758240),
        ironwolfs = vec3:new(120.874367, -746.962341, 7.089052),
